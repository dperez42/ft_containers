...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/09 17:45:57 by dperez-z          #+#    #+#             */
/*   Updated: 2022/05/09 17:45:59 by dperez-z         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	template <class It1>
	bool	operator==(const reverse_iterator<It1> &lhs, const reverse_iterator<It1> &rhs)
	{ return lhs.get_pointer() == rhs.get_pointer();}
