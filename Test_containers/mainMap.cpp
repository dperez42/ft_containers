 //clang++ -Werror -Wall -Wextra -fsanitize=address mainMap.cpp
#include "map.hpp"
#include <map>
# include <sys/stat.h> 
# include <sys/types.h>
...
int main ()
{
  std::cout << BOLD_RED << "MAP :\n" << NORMAL << NORMAL ;
    ...
    std::cout << "constructor_default:";
		std::cout << ((printMapAttributes(fs, stl_default_map, ft_default_map) == true) ?  "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
  ...
  /* Range constrcutor */
	{
		const int range_int[] = {-652, -4, 98, 54, -210, -652};
		const std::string range_str[] = {"One", "Two", "Three", "Four", "Five","One"};
		...
		std::cout << ((printMapAttributes(fs, stl_map_copy, ft_map_copy) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
  ...
  std::cout << std::endl;
	...
	/* Begin */
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
		std::cout << "[";
		std::cout << ((printSingleValue(fs, (*stl_map.begin()).first, (*ft_map.begin()).first) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << ((printSingleValue(fs, (*stl_map.begin()).second, (*ft_map.begin()).second) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << "]\n";
    ...
    std::cout << "begin_const:";
		printMapAttributes(fs, stl_map, ft_map);
		std::cout << "[";
		std::cout << ((printSingleValue(fs, (*stl_it).first, (*ft_it).first) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << ((printSingleValue(fs, (*stl_it).second, (*ft_it).second) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << "]\n";
  ...
  /* Const end */
    ...
    std::cout << "empty_true:";
		std::cout << ((printBoolResult(fs, stl_default_map.empty(), ft_default_map.empty()) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
	...
	/* Empty false */
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
		std::cout << ((printBoolResult(fs, stl_map.empty(), ft_map.empty()) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
	...
	/* Size */
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
		std::cout << "[";
		std::cout << ((printSingleValue(fs, stl_map.size(), ft_map.size()) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
	...
	/* Maximum size */
	{
		...
		printMapAttributes(fs, stl_default_map, ft_default_map);
    std::cout << "max_size:";
		std::cout << ((printSingleValue(fs, stl_default_map.max_size(), ft_default_map.max_size()) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
	...
	/* Operator [] */
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
    std::cout << "operator_at:";
		std::cout << "[";
		std::cout << ((printSingleValue(fs, stl_map[-9], ft_map[-9]) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
...
*/
    ...
    std::cout << "insert_hint:";
		std::cout << ((printMapAttributes(fs, stl_map, ft_map) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
    ...
    std::cout << "insert_range:";
		std::cout << ((printMapAttributes(fs, stl_map_one, ft_map_one) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
  ...
  /* Erase single */
  	...
  	/* Swap */
	{
    	...
    	std::cout << "swap:";
		std::cout << ((printMapAttributes(fs, stl_map_one, ft_map_one) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << ((printMapAttributes(fs, stl_map_two, ft_map_two) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
  ...
  /* Clear */
    ...
    std::cout << "key_comp:";
		std::cout << ((printBoolResult(fs, stl_res, ft_res) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
		fs << "\nCode executed:\n";
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
	...
	/* Find not exist*/
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
		std::cout << "find_not_exist:";
		std::cout << ((printBoolResult(fs, (stl_it == stl_map.end()), (ft_it == ft_map.end())) == true) ? "\033[1;32m[OK]\033[0;37m\n" : "\033[1;31m[NOP]\033[0;37m\n");
    ...
    std::cout << "count:";
		std::cout << "[";
		std::cout << ((printBoolResult(fs, (stl_map.count(-98) > 0), (ft_map.count(-98) > 0)) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << ((printBoolResult(fs, (stl_map.count(42) > 0), (ft_map.count(42) > 0)) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << "]\n";
	...
	/* Equal range */
	{
		...
		printMapAttributes(fs, stl_map, ft_map);
    std::cout << "equal_range_const:";
		std::cout << "[";
		std::cout << ((printSingleValue(fs, (*(stl_map.equal_range(65).first)).first, (*(ft_map.equal_range(65).first)).first) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << ((printSingleValue(fs, (*(stl_map.equal_range(65).second)).first, (*(ft_map.equal_range(65).second)).first) == true) ? "\033[1;32m[OK]\033[0;37m" : "\033[1;31m[NOP]\033[0;37m");
		std::cout << "]\n";
